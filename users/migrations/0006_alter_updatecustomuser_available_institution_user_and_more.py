...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('users', '0005_rename_available_institution_updatecustomuser_available_institution_user_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='institutions.availableinstitution'),
        ),
        migrations.AlterField(
            model_name='updatecustomuser',
            name='institution',
